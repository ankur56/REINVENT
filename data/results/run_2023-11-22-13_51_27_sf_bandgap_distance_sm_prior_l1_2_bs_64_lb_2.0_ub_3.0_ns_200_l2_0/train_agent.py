...
def train_agent(restore_prior_from='data/Prior.ckpt',
    ...
    # Scoring_function
    scoring_function_call = get_scoring_function(scoring_function=scoring_function, num_processes=num_processes, batch_size=batch_size, upper_limit=ub, lower_limit=lb,
